...
<div align="center" style="margin-top: 40px; margin-bottom: 60px;">
  <h1 style="font-size: 3em; font-weight: bold; margin-bottom: 0;">ArcLab Studio</h1>
  <p style="color: #00e5ff; font-size: 1.2em; letter-spacing: 1px;">V 1.3.1 Alpha Release</p>
  
  <p style="max-width: 600px; margin: 20px auto; font-size: 1.1em; color: #b0bec5;">
    El entorno definitivo para la creación de diagramas de electrónica digital.
  </p>
