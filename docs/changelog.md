...
<div class="steam-card">
  ...
  <div class="steam-content">
    ...
    <div class="steam-desc">
      Hemos mejorado la redacción del texto descriptivo en system verilog, ahora tiene una estructura mucho más legible y limpia, ideal para diseños rapidos y llevar directamente a implementación sin la necesidad de tener que renombrar nodos, entradas y salidas. Además ahora te notificaremos cuando este disponible una nueva actulización, aparecerá una ventana emergente y te enviará al centro de descargas para que puedas actualizar tu versión y obtener todas las cosas que estamos desarrollando para ti ❤️
    </div>
